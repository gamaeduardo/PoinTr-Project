...
import { FiPlus, FiBriefcase, FiUsers, FiSearch, FiBell, FiUser, FiHelpCircle, FiSettings, FiLogOut } from 'react-icons/fi';

const CompanySelector = () => {
  const { companies, setCompany } = useCompanyStore();
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 cursor-pointer group">
              <div className="text-right hidden sm:block">
                <p className="text-xs font-bold text-primary-text leading-none">Admin Master</p>
                <p className="text-[10px] text-secondary-text leading-tight mt-1">Gerência Global</p>
              </div>
              <div className="w-10 h-10 rounded-full border border-main-border group-hover:border-accent transition-all p-0.5 overflow-hidden bg-slate-800">
                <img src="https://ui-avatars.com/api/?name=Admin+Master&background=6366f1&color=fff" alt="Perfil" className="rounded-full"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="pt-2 pb-2 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="min-h-screen bg-main-bg flex flex-col items-center justify-center p-6">
            ...
            >
                <h1 className="text-4xl font-black text-primary-text mb-2">Bem-vindo, Gerente</h1>
                            ...
                            <div>
                                ...
                                <div className="flex items-center text-secondary-text mt-2 space-x-4">
                                    <span className="flex items-center text-xs">
                                        <FiUsers className="mr-1.5" /> {company.workers} colaboradores
                                    </span>
                                </div>
                            </div>
                        </div>
