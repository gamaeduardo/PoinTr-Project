            ...
            <div className="flex items-center space-x-6 h-full">
                <div className="relative flex items-center justify-center">
                    <svg className="w-20 h-20 transform -rotate-90">
                        <circle cx="40" cy="40" r="35" stroke="currentColor" strokeWidth="6" fill="transparent" className="text-primary-text/5" />
                    ...
                    <span className="absolute text-sm font-bold text-primary-text">{rate}%</span>
                </div>
                <div className="flex-1 space-y-2">
                    <div className="flex justify-between items-center">
                        <span className="text-[10px] text-gray-500 uppercase">Atestados</span>
                        <span className="text-xs text-primary-text font-bold">4</span>
                    </div>
